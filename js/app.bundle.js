    ...
    var e = {
            ...
            8240: function(e, t, n) {
                ...
                function p(e, t, n) {
                    ...
                    return (h || !h && !n) && (("body" !== (0, a.Z)(t) || (0, c.Z)(g)) && (b = (p = t) !== (0, r.Z)(p) && (0, o.Re)(p) ? {
                        ...
                        var s, a, l = {
                            ...
                            u = {
                                ...
                                setOptions: function(n) {
                                    ...
                                    }((a = [].concat(i, l.options.modifiers), c = a.reduce((function(e, t) {
                                        var n = e[t.name];
                ...
                function p(e) {
                    ...
                    if (g) {
                        var O = (0, s.Z)(n),
                            P = "clientHeight",
                            M = "clientWidth";
                        O === (0, r.Z)(n) && (O = (0, o.Z)(n), "static" !== (0, a.Z)(O).position && "absolute" === h && (P = "scrollHeight", M = "scrollWidth")), (d === i.we || (d === i.t$ || d === i.F2) && p === i.ut) && (k = i.I, C -= (b && O === A && A.visualViewport ? A.visualViewport.height : O[P]) - l.height, C *= m ? 1 : -1), d !== i.t$ && (d !== i.we && d !== i.I || p !== i.ut) || (S = i.F2, y -= (b && O === A && A.visualViewport ? A.visualViewport.width : O[M]) - l.width, y *= m ? 1 : -1)
                    }
                    var L, $ = Object.assign({
                            position: h
                        }, g && u),
                    ...
                    return y = I.x, C = I.y, m ? Object.assign({}, $, ((L = {})[k] = _ ? "0" : "", L[S] = T ? "0" : "", L.transform = (A.devicePixelRatio || 1) <= 1 ? "translate(" + y + "px, " + C + "px)" : "translate3d(" + y + "px, " + C + "px, 0)", L)) : Object.assign({}, $, ((t = {})[k] = _ ? C + "px" : "", t[S] = T ? y + "px" : "", t.transform = "", t))
                }
                t.Z = {
                    name: "computeStyles",
                    enabled: !0,
                        ...
                        fn: function(e) {
                            ...
                            if (!t.modifiersData[i]._skip) {
                                for (var o = n.mainAxis, u = void 0 === o || o, p = n.altAxis, f = void 0 === p || p, h = n.fallbackPlacements, m = n.padding, g = n.boundary, v = n.rootBoundary, b = n.altBoundary, w = n.flipVariations, y = void 0 === w || w, x = n.allowedAutoPlacements, C = t.options.placement, E = (0, r.Z)(C), T = h || (E !== C && y ? function(e) {
                                        ...
                                        var t = s(e);
                                        return [a(e), t, a(t)]
                                    }(C) : [s(C)]), _ = [C].concat(T).reduce((function(e, n) {
                                    ...
                                    }), []), S = t.rects.reference, k = t.rects.popper, A = new Map, O = !0, P = _[0], M = 0; M < _.length; M++) {
                                    var L = _[M],
                                        $ = (0, r.Z)(L),
                                        I = (0, d.Z)(L) === c.BL,
                            ...
                            l = s.Ct.reduce((function(e, n) {
                                return e[n] = function(e, t, n) {
                                    var r = (0, i.Z)(e),
                                        ...
                                        l = a[0],
                                        d = a[1];
                                    return l = l || 0, d = (d || 0) * o, [s.t$, s.F2].indexOf(r) >= 0 ? {
                                        x: d,
                                        y: l
                                    } : {
                                        x: l,
                    ...
                    f = {
                        ...
                        fn: function(e) {
                            var t = e.state,
                                ...
                                $ = t.rects.reference,
                                I = t.rects.popper,
                                D = "function" == typeof _ ? _(Object.assign({}, t.rects, {
                                    placement: t.placement
                                })) : _,
                                j = "number" == typeof D ? {
                                    mainAxis: D,
                ...
                function w(e, t, n) {
                    return t === i.Pj ? b(function(e, t) {
                        ...
                        var t, n = (0, r.Z)(e),
                            ...
                            f = -i.scrollTop;
                        return "rtl" === (0, l.Z)(s || n).direction && (p += (0, c.Fp)(n.clientWidth, s ? s.clientWidth : 0) - a), {
                            width: a,
                            height: u,
                            x: p,
                            y: f
                ...
                e.exports = function(e) {
                    ...
                    const g = {
                        ...
                        off(e, t, n, s) {
                            ...
                            const [r, o, a] = u(t, n, s), l = a !== t, c = d(e), p = c[a] || {}, m = t.startsWith(".");
                            if (void 0 === o) {
                                if (m)
            ...
            9872: function(e, t, n) {
                e.exports = function(e, t, n, i, s, r) {
                    "use strict";
                    const o = e => e && "object" == typeof e && "default" in e ? e : {
                        default: e
                    };
                    ...
                    return d.default.on(document, v, w, P.dataApiKeydownHandler), d.default.on(document, v, x, P.dataApiKeydownHandler), d.default.on(document, g, P.clearMenus), d.default.on(document, "keyup.bs.dropdown.data-api", P.clearMenus), d.default.on(document, g, w, (function(e) {
                        e.preventDefault(), P.getOrCreateInstance(this).toggle()
                    })), t.defineJQueryPlugin(P), P
            ...
            7424: function(e, t, n) {
                e.exports = function(e, t, n, i, s, r, o, a) {
                    ...
                    })), a.enableDismissTrigger(E), e.defineJQueryPlugin(E), E
                ...
                e.exports = function(e, t, n) {
                    ...
                    class u extends r.default {
                        ...
                        show(e) {
                            ...
                            this._config.isAnimated && t.reflow(n), n.classList.add(a), this._emulateAnimation((() => {
                                t.execute(e)
                            }))
                        }
                        hide(e) {
                            this._config.isVisible ? (this._getElement().classList.remove(a), this._emulateAnimation((() => {
            ...
            744: function(e, t, n) {
                e.exports = function(e, t, n) {
                    ...
                    class f extends o.default {
                        ...
                        activate() {
                            this._isActive || (this._config.autofocus && this._config.trapElement.focus(), s.default.off(document, a), s.default.on(document, l, (e => this._handleFocusin(e))), s.default.on(document, d, (e => this._handleKeydown(e))), this._isActive = !0)
                        }
                        deactivate() {
            ...
            4072: function(e, t) {
                ! function(e) {
                    ...
                    }, e.findShadowRoot = o, e.getElement = e => r(e) ? e.jquery ? e[0] : e : "string" == typeof e && e.length > 0 ? document.querySelector(e) : null, e.getElementFromSelector = e => {
                        const t = n(e);
        ...
        function() {
                    ...
                    updateSlides: function() {
                        ...
                        for (let s = 0; s < u; s += 1) {
                            ...
                            if (T && e.grid.updateSlide(s, o, u, t), "none" !== o.css("display")) {
                                ...
                                c[s] && (c[s].swiperSlideSize = _), h.push(_), i.centeredSlides ? (x = x + _ / 2 + C / 2 + y, 0 === C && 0 !== s && (x = x - r / 2 - y), 0 === s && (x = x - r / 2 - y), Math.abs(x) < .001 && (x = 0), i.roundLengths && (x = Math.floor(x)), E % i.slidesPerGroup == 0 && p.push(x), f.push(x)) : (i.roundLengths && (x = Math.floor(x)), (E - Math.min(e.params.slidesPerGroupSkip, E)) % e.params.slidesPerGroup == 0 && p.push(x), f.push(x), x = x + _ + y), e.virtualSize += _ + y, C = _, E += 1
                            }
                        }
            ...
            var A = {
                ...
                O = {
                    ...
                    loopFix: function() {
                        ...
                        t < i ? (l = n.length - 3 * i + t, l += i, e.slideTo(l, 0, !1, !0) && 0 !== d && e.setTranslate((a ? -e.translate : e.translate) - d)) : t >= n.length - i && (l = -n.length + t + i, l += i, e.slideTo(l, 0, !1, !0) && 0 !== d && e.setTranslate((a ? -e.translate : e.translate) - d)), e.allowSlidePrev = s, e.allowSlideNext = r, e.emit("loopFix")
                    },
            ...
            function P(e) {
                ...
                if (Object.assign(r, {
                        ...
                        isScrolling: void 0,
                        startMoving: void 0
                    }), l.startX = m, l.startY = v, r.touchStartTime = g(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, a.threshold > 0 && (r.allowThresholdMove = !1), "touchstart" !== c.type) {
                    let e = !0;
            ...
            const z = (e, t) => {
                ...
                if (d.touch) {
                    ...
                    o[u](r.start, e.onTouchStart, t), o[u](r.move, e.onTouchMove, d.passiveListener ? {
                        passive: !1,
                        capture: c
                    } : c), o[u](r.end, e.onTouchEnd, t), r.cancel && o[u](r.cancel, e.onTouchEnd, t)
                } else o[u](r.start, e.onTouchStart, !1), n[u](r.move, e.onTouchMove, c), n[u](r.end, e.onTouchEnd, !1);
                (i.preventClicks || i.preventClicksPropagation) && o[u]("click", e.onClick, !0), i.cssMode && a[u]("scroll", e.onScroll), i.updateOnWindowResize ? e[p](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", $, !0) : e[p]("observerUpdate", $, !0)
            };
            var Z = {
                attachEvents: function() {
                    ...
                    e.onTouchStart = P.bind(e), e.onTouchMove = M.bind(e), e.onTouchEnd = L.bind(e), n.cssMode && (e.onScroll = D.bind(e)), e.onClick = I.bind(e), i.touch && !j && (t.addEventListener("touchstart", N), j = !0), z(e, "on")
                },
            ...
            class q {
                constructor(...e) {
                    ...
                    i.__swiper__ = !0, i.support = T(), i.device = function(e = {}) {
                        return C || (C = function({
                            ...
                            const u = s.match(/(iPod)(.*OS\s([\d_]+))?/),
                                ...
                                f = "Win32" === i;
                            let h = "MacIntel" === i;
                            return !c && h && t.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${a}x${l}`) >= 0 && (c = s.match(/(Version)\/([\d.]+)/), c || (c = [0, 1, "13_0_0"]), h = !1), d && !f && (r.os = "android", r.android = !0), (c || p || u) && (r.os = "ios", r.ios = !0), r
                        }(e)), C
                    }({
                    ...
                    const r = b({}, F, s);
                    return i.params = b({}, r, H, n), i.originalParams = b({}, i.params), i.passedParams = b({}, n), i.params && i.params.on && Object.keys(i.params.on).forEach((e => {
                    ...
                    !r.hasClass(s.elementClass) || r.hasClass(s.loadedClass) || r.hasClass(s.loadingClass) || o.push(r[0]), 0 !== o.length && o.each((t => {
                        ...
                        e.loadImage(o[0], d || l, c, u, !1, (() => {
                            if (null != e && e && (!e || e.params) && !e.destroyed) {
                                if (l ? (o.css("background-image", `url("${l}")`), o.removeAttr("data-background")) : (c && (o.attr("srcset", c), o.removeAttr("data-srcset")), u && (o.attr("sizes", u), o.removeAttr("data-sizes")), p.length && p.children("source").each((e => {
                                        const t = h(e);
                                        t.attr("data-srcset") && (t.attr("srcset", t.attr("data-srcset")), t.removeAttr("data-srcset"))
                                    })), d && (o.attr("src", d), o.removeAttr("data-src"))), o.addClass(s.loadedClass).removeClass(s.loadingClass), r.find(`.${s.preloaderClass}`).remove(), e.params.loop && n) {
                    ...
                    function(e) {
                        ...
                        setTranslate: () => {
                            const {
                                ...
                                slides: i,
                                slidesSizesGrid: s
                            } = e, r = e.params.coverflowEffect, o = e.isHorizontal(), a = e.translate, l = o ? t / 2 - a : n / 2 - a, d = o ? r.rotate : -r.rotate, c = r.depth;
                            for (let e = 0, t = i.length; e < t; e += 1) {
                                ...
                                if (ne(r, t).transform(b), t[0].style.zIndex = 1 - Math.abs(Math.round(a)), r.slideShadows) {
                                    ...
                                    0 === e.length && (e = te(r, t, o ? "left" : "top")), 0 === n.length && (n = te(r, t, o ? "right" : "bottom")), e.length && (e[0].style.opacity = a > 0 ? a : 0), n.length && (n[0].style.opacity = -a > 0 ? -a : 0)
                                }
                            }
                        },
                        setTransition: t => {
            ...
            function Ge(e, t) {
                var n, i, s, r, o, a, l, d, c = Ie(e, Object.assign({}, Me, $e(be(t)))),
                    u = !1,
                    p = !1,
                    f = !1,
                    h = !1,
                    ...
                    w = {
                        ...
                        setProps: function(t) {
                            if (!w.state.isDestroyed) {
                                ...
                                var n = w.props,
                                    i = Ie(e, Object.assign({}, n, be(t), {
                                        ignoreAttributes: !0
                                    }));
                                w.props = i, R(), n.interactiveDebounce !== i.interactiveDebounce && (j(), g = he(W, i.interactiveDebounce)), n.triggerTarget && !i.triggerTarget ? me(n.triggerTarget).forEach((function(e) {
                            ...
                            if (!(e || t || n || i || A().hasAttribute("disabled") || ($("onShow", [w], !1), !1 === w.props.onShow(w)))) {
                                ...
                                a = function() {
                                    ...
                                    if (w.state.isVisible && !h) {
                                        ...
                                        I(), D(), ge(Fe, w), null == (e = w.popperInstance) || e.forceUpdate(), $("onMount", [w]), w.props.animation && k() && function(e, t) {
                                            F(e, (function() {
                                                w.state.isShown = !0, $("onShown", [w])
                                            }))
                                        }(s)
                                    }
                                }, l = w.props.appendTo, d = A(), (o = w.props.interactive && l === ce || "parent" === l ? d.parentNode : fe(l, [d])).contains(x) || o.appendChild(x), w.state.isMounted = !0, K()
                            }
                        },
                        hide: function() {
                            var e = !w.state.isVisible,
                        ...
                        unmount: function() {
                            w.state.isVisible && w.hide(), w.state.isMounted && (Q(), J().forEach((function(e) {
                                e._tippy.unmount()
                            })), x.parentNode && x.parentNode.removeChild(x), Fe = Fe.filter((function(e) {
                                return e !== w
                ...
                return R(), D(), L(), $("onCreate", [w]), c.showOnCreate && ee(), x.addEventListener("mouseenter", (function() {
                ...
                function D() {
                    !T && w.props.aria.expanded && me(w.props.triggerTarget || e).forEach((function(e) {
                        w.props.interactive ? e.setAttribute("aria-expanded", w.state.isVisible && e === A() ? "true" : "false") : e.removeAttribute("aria-expanded")
                    }))
                }

                function j() {
                    O().removeEventListener("mousemove", g), Be = Be.filter((function(e) {
                        return e !== g
                    }))
                }
                ...
                function N(t) {
                    if (!_e.isTouch || !f && "mousedown" !== t.type) {
                        ...
                        if (!w.props.interactive || !Te(x, n)) {
                            if (me(w.props.triggerTarget || e).some((function(e) {
                                    return Te(e, n)
                                }))) {
                ...
                function G(t, n, i) {
                    void 0 === i && (i = !1), me(w.props.triggerTarget || e).forEach((function(e) {
                ...
                function q(e) {
                    ...
                    if (w.state.isEnabled && !X(e) && !p) {
                        ...
                        r = e, l = e.currentTarget, D(), !w.state.isVisible && pe(e, "MouseEvent") && Be.forEach((function(t) {
                            return t(e)
                ...
                function K() {
                    ...
                    }), c.push.apply(c, (null == n ? void 0 : n.modifiers) || []), w.popperInstance = (0, se.fi)(d, x, Object.assign({}, n, {
                        placement: i,
                        onFirstUpdate: a,
                        modifiers: c
                    }))
            ...
            Re.defaultProps = Me, Re.setDefaultProps = function(e) {
                Object.keys(e).forEach((function(t) {
                    Me[t] = e[t]
                }))
            }, Re.currentInput = _e, Object.assign({}, re.Z, {
                effect: function(e) {
                    var t = e.state,
                        n = {
                            popper: {
            ...
            new class {
                ...
                constructor() {
                    this.initFullSlider(), this.initCenteredSlider(), this.initCardSlider(), this.initCollectionsSlider(), this.initCardSlider3Columns(), this.initCardSlider3ColumnsLargeGap(), this.initCoverflowSlider(), this.initCoverflowSlider2(), this.initCardSlider2Columns(), this.initSingleSlider()
                }
                initFullSlider() {
                ...
                constructor() {
                    Ye(this, "subscribeToSocketPrices", (e => this.pricesWs.onmessage = function(t) {
                        e(t.data)
                    ...
                    })), Ye(this, "formattedPrice", (e => new Intl.NumberFormat("default", {
                        style: "currency",
                        currency: "USD"
                    }).format(e))), Ye(this, "formattedPriceChange", (e => {
                        if (isNaN(e)) return "-";
                        ...
                        return e > 0 ? '<span class="text-green">'.concat(t, "</span>") : e < 0 ? '<span class="text-red">'.concat(t, "</span>") : void 0
                    })), Ye(this, "renderData", (e => {
                        e.forEach(((e, t) => {
                            const n = '<div class="flex crypto-price items-center" data-currency='.concat(e.id, '>\n        <div class="crypto-price__index hidden sm:block lg:pl-10 pl-4 w-[6%] text-sm">').concat(t + 1, '</div>\n        <div class="crypto-price__coin flex w-[36%] items-center px-3 py-5">\n          <img src="./img/coins/').concat(e.symbol.toLowerCase(), '.svg" alt="" width="24" height="24" class="mr-2 flex-shrink-0" />\n          <div class="crypto-price__name flex-1 text-sm font-display font-semibold">\n            <span class="text-jacarta-700 dark:text-white mr-3">').concat(e.name, '</span>\n            <span class="text-jacarta-300">').concat(e.symbol, '</span>\n          </div>\n        </div>\n        <div class="crypto-price__price lg:w-[16%] text-right w-[24%] px-3 py-5 text-jacarta-700 dark:text-white" data-price="').concat(e.priceUsd, '">').concat(this.formattedPrice(e.priceUsd), '</div>\n        <div class="crypto-price__volume w-1/5 hidden text-right md:block px-3 py-5">').concat(this.formattedPrice(e.volumeUsd24Hr), '</div>\n        <div class="crypto-price__change lg:w-[12%] text-right w-[16%] px-3 py-5">').concat(this.formattedPriceChange(e.changePercent24Hr), '</div>\n        <div class="crypto-price__trade w-[10%] pl-3 pr-4 py-5 text-right"><a href="#" class="rounded-full hover:bg-jacarta-700 bg-green px-5 py-2 text-white font-display font-semibold text-sm">Buy</a></div>\n      </div>');
                            this.cryptoPrices.insertAdjacentHTML("beforeend", n)
                        }))
                    })), this.cryptoPrices = document.getElementById("js-crypto-prices"), this.pricesWs = new WebSocket("".concat("wss://ws.coincap.io", "/prices?assets=").concat(Ue)), this.fetchData()
                }
                async fetchData() {
                    try {
                        ...
                        const {
                            data: e
                        } = await fetch("".concat("https://api.coincap.io/v2", "/assets?limit=").concat(5, "&ids=").concat(Ue)).then((e => e.json()));
